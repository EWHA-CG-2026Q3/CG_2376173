...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(98, 60);
    [SerializeField] private Vector2 vertexB = new Vector2(128, 200);
    [SerializeField] private Vector2 vertexC = new Vector2(158, 60);
    [SerializeField] private Color fillColor = new Color(0.2f, 0.6f, 0.2f, 1f);
